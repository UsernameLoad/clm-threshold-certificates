...
The scripts, run records and the numerical census that reproduce every quantitative statement in Sections~\ref{sec:rate} and \ref{sec:numerics} are archived at \url{https://github.com/UsernameLoad/clm-threshold-certificates}.
